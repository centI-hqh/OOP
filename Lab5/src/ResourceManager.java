...
public class ResourceManager<T extends Upgradeable> {
    ...
    public void addResource(String name, T resource) {
        ...
        if (!resourceTypes.contains(type)) resourceTypes.add(type);
        updateTotalUpgradeCost();
    }

    public T getResource(String name) { return resources.get(name); }
    ...
    public void addGold(int amount) { availableGold += amount; }
